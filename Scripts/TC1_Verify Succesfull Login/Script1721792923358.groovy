...
WebUI.verifyNotEqual(findTestObject('Page_CURA Healthcare Service_Login/a_Make Appointment'), findTestObject('Page_CURA Healthcare Service_Login/h2_Make Appointment'))
